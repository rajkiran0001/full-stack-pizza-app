...
class ContactForm extends Component {
  ...
  adduser = _ => {
    ...
    if (isValid) {
    fetch(`https://full-stack-pizza-app-server.herokuapp.com/userDetails/add?uid=${user.uid}&name=${user.name}&email=${user.email}&phone=${user.phone}&address=${user.address}&euro=${cartEuroTotal}&dollar=${cartDollarTotal}`)
    .then(this.getusers)
